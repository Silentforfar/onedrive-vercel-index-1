...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Share@sunover.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://ovi.swo.moe/zh/docs/getting-started',
    },
    {
      name: 'Telegram',
      link: '',
